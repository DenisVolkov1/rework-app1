...
public class NewRework {
	...
	public NewRework(String wms, String reworkNumber, String wikiLink, String description, String project,
	...
	public String toString() {
		return "NewRework [wms=" + wms + ", reworkNumber=" + reworkNumber + ", wikiLink=" + wikiLink + ", description="
